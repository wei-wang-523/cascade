...
public interface Expression {
	public static enum Kind {
		...
		GEQ,
		/**
		 * A type predicate TODO: Should have two children: a type and an
		 * expression, but children have to be expressions... ???
		 */
		HAS_TYPE,
		/**
		...
		REWRITE_RULE,
		/**
		 * Actual rule. Two/Three children: the head, the body, (the triggers,
		 * optional)
		 */
		RR_REWRITE,
		/**
	...
	/**
	 * Coerce the expression to a <code>FunctionExpression</code>. Throws an
	 * exception if the expression is not of function type.
	 */
	 ...
	 * <code>e</code> in <code>oldExprs</code> for the corresponding expression
