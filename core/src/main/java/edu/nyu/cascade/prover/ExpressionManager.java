...
public interface ExpressionManager {
   ...
   */
  BooleanExpression and(Expression left,
      Expression right);
   ...
   */
  BooleanExpression and(Expression first,
      Expression... rest);
...
*/
  ...
  BitVectorExpression bitwiseAnd(Expression a,
      Expression b);

  BitVectorExpression bitwiseNand(Expression a,
      Expression b);

  BitVectorExpression bitwiseNor(Expression a,
      Expression b);

  BitVectorExpression bitwiseNot(Expression a);

  BitVectorExpression bitwiseOr(Expression a,
      Expression b);

  BitVectorExpression bitwiseXnor(Expression a,
      Expression b);

  BitVectorExpression bitwiseXor(Expression a,
      Expression b);
   ...
   */
  BitVectorExpression concat(Expression left,
      Expression right);
   ...
   */
  BooleanExpression distinct(Expression first,
   ...
   */
  BitVectorExpression rem(Expression numerator,
      Expression denominator);

  BitVectorExpression signedRem(Expression numerator,
      Expression denominator);
   ...
   */
  BooleanExpression eq(Expression left,
      Expression right);
...
/*  FunctionType functionType(
   ...
   */
  BooleanExpression greaterThanOrEqual(Expression left,
      Expression right);

  /**
   * Create a new signed greater than or equal expression.
   */
  BooleanExpression signedGreaterThanOrEqual(Expression left,
      Expression right);
   ...
   */
  BooleanExpression greaterThan(Expression lhs,
      Expression rhs);
   ...
   * @return the or of left and right
   */
  BooleanExpression iff(Expression left,
      Expression right);
  ...
  /**
   * Get the integer range type object, given the expressions for lower and
   ...
   */
  IntegerType integerRangeType(Expression lBound,
      Expression uBound);
   ...
   */
  BooleanExpression lessThanOrEqual(Expression left,
      Expression right);

  /**
   * Create a new signed less than or equal expression
   */
  BooleanExpression signedLessThanOrEqual(Expression left,
      Expression right);
  
  /**
   * Create a new less than expression
   */
  BooleanExpression lessThan(Expression left,
      Expression right);

  /**
   * Create a new signed less than expression
   */
  BooleanExpression signedLessThan(Expression left, 
      Expression right);
  
  BitVectorExpression bitVectorMinus(Expression a,
      Expression b);
  ...
  BooleanExpression neq(Expression arg0,
      Expression arg1);
   ...
   * @return the or of left and right
   */
  BooleanExpression or(Expression left,
      Expression right);
  ...
  /**
   * Get the rational range type object, given the expressions for lower and
   * upper bounds (inclusive).
   * 
   * @param lBound
   *          lower bound of the range
   * @param uBound
   *          upper bound of the range
   * @return the rational range type
   */
  RationalType rationalRangeType(Expression lBound, Expression uBound);
   ...
   */
  BooleanExpression xor(Expression left,
      Expression right);
