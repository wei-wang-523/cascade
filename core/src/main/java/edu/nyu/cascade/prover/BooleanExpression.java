...
public interface BooleanExpression extends Expression {
	...
	/**
	 * Add a no trigger pattern p to a quantified expression. A trigger pattern is
	 * a term or atomic predicate that is a sub-expression of this expression. The
	 * free variables of p will not be used to instantiate the quantified
	 * variables of this expression during query processing. p will be added to
	 * the end of the list of noTriggers for e, i.e., it will be matched last.
	 * 
