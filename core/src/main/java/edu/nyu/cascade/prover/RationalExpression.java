 ...
 * all needed operations on rational numbers are provided. These methods should use the same
...
public interface RationalExpression extends Expression {
	 ...
	 * comparison (>) over this expression and a given rational expression <code>e</code>. 
	...
	/**
	 * Returns a new rational expression that is the sum of this expression
	...
	/**
	 * Returns a new rational expression that is the multiplication of this expression
	 * and a given expression <code>e</code>.
	...
	/**
	 * Returns a new rational expression that is the ratio of this expression
	 * and a given expression <code>e</code>.
	...
	/**
	 * Returns a new rational expression that is the exponentiation of this expression
