...
public interface IntegerExpression extends Expression {
	...
	/**
	 * Returns a new Boolean expression that represents a greater than (>) over
	 * this expression and a given integer expression <code>e</code>.
	 * 
	 * @param e
	 ...
	 * comparison (>=) over this expression and a given integer expression
	 * <code>e</code>.
	 * 
	 * @param e
	 *          expression to compare to
	...
	/**
	 * Returns a new Integer expression that is the sum of this expression and a
	...
	/**
	 * Returns a new Integer expression that is the sum of this expression and a
	 * given expression <code>rest</code>.
	 * 
	 * @param rest
	 *          the expression to add
	 * @return the sum expression
	...
	/**
	 * Returns a new Integer expression that is the multiplication of this
	...
	/**
	 * Returns a new Integer expression that is the ratio of this expression and a
	 * given expression <code>e</code>.
	 * 
	 * @param e
	...
	/**
	 * Returns a new Integer expression that is the exponentiation of this
