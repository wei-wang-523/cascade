 ...
 *
 * <p />
 * To recreate this class, compile <code>limits.c</code> in the same directory
 * as this interface and run the resulting executable while piping standard
 * output to <code>Limits.java</code>.
 *
 * <p />
 * The rank for pointer difference, sizeof, and wide character types reflects
 * the ordering <code>char</code>, <code>short</code>, <code>int</code>,
 * <code>long</code>, and <code>long long</code>, starting at 1 and ignoring the
 * sign. This program requires that the <code>__PTRDIFF_TYPE__</code>,
 * <code>__SIZE_TYPE__</code>, and <code>__WCHAR_TYPE__</code> preprocessor
 * macros are defined.
 *
 * @author Robert Grimm
 * @version $Revision$
...
class Limits64 {
	...
	public static final String COMPILER_NAME = "clang";

	/** The C compiler version. */
	public static final String COMPILER_VERSION = "6.0 (clang-600.0.54)";

	/** The major C compiler version. */
	public static final int COMPILER_VERSION_MAJOR = 6;
	...
	/**
	 * The flag for whether string literals consist of <code>const char</code>
	 * elements.
	 */
	...
	public static final BigInteger LONG_MIN = new BigInteger(
			"-9223372036854775808");

	/** The maximum value of signed long types. */
	public static final BigInteger LONG_MAX = new BigInteger(
			"9223372036854775807");

	/** The maximum value of unsigned long types. */
	public static final BigInteger ULONG_MAX = new BigInteger(
