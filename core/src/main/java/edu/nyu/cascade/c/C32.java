...
public class C32 extends xtc.type.C {
  ...
  static {
    GCC_LEGACY_LAYOUT =
      Limits32.COMPILER_NAME.equals("gcc") &&
  ...
  protected static final NumberT.Kind KIND_SIZEOF =
    IntegerT.fromRank(Limits32.SIZEOF_RANK, false);
  ...
  protected static final NumberT.Kind KIND_PTR_DIFF =
    IntegerT.fromRank(Limits32.PTRDIFF_RANK, true);
  ...
  protected static final NumberT.Kind KIND_WCHAR =
    IntegerT.fromRank(Limits32.WCHAR_RANK, Limits32.IS_WCHAR_SIGNED);
  ...
  public long getAlignment(Type type, boolean natural) {
    ...
    case FLOAT:
      ...
      case LONG_LONG:
      case U_LONG_LONG:
        return natural ? Limits32.LONG_LONG_NAT_ALIGN : Limits32.LONG_LONG_ALIGN;
      case FLOAT:
      ...
      case LONG_DOUBLE:
        return natural ? Limits32.LONG_DOUBLE_NAT_ALIGN : Limits32.LONG_DOUBLE_ALIGN;
      case FLOAT_COMPLEX:
        return natural ? Limits32.FLOAT_NAT_ALIGN : Limits32.FLOAT_ALIGN;
      case DOUBLE_COMPLEX:
        return natural ? Limits32.DOUBLE_NAT_ALIGN : Limits32.DOUBLE_ALIGN;
      ...
      if (! var.hasKind(VariableT.Kind.BITFIELD)) {
        ...
        if (isPacked && (GCC_LEGACY_LAYOUT || 0 != width)) {
          ...
          if (isLastMember || -1 == members.get(i+1).getWidth()) {
            ...
            if (0 != bitCount % Limits32.CHAR_BITS) size++;
        ...
        if (Constants.NAME_GCC.equals(att.getName())) {
          ...
          if ("aligned".equals(att.getName())) {
            if (null == att.getValue()) {
              alignment =
                Math.max(Limits32.LONG_LONG_ALIGN, Limits32.LONG_DOUBLE_ALIGN);
            } else {
  ...
  @SuppressWarnings("incomplete-switch")
    ...
    case INTEGER:
      ...
      case CHAR:
        return Limits32.IS_CHAR_SIGNED?
          Limits32.fitsChar(number) : Limits32.fitsUnsignedChar(number);
      case S_CHAR:
   ...
   */
    ...
    // signed.
    boolean flip = ((! Limits32.IS_INT_SIGNED) &&
                    type.hasVariable() &&
  ...
  protected final BigInteger FACTOR_CHAR =
    BigInteger.valueOf(2).pow(Limits32.CHAR_BITS);

  /** The factor for wide chars. */
  protected final BigInteger FACTOR_WIDE =
    BigInteger.valueOf(2).pow(Limits32.CHAR_BITS * Limits32.WCHAR_SIZE);
