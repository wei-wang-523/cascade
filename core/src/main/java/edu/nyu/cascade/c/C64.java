...
public class C64 extends C {
  ...
  static {
    GCC_LEGACY_LAYOUT =
      Limits64.COMPILER_NAME.equals("gcc") &&
  ...
  protected static final NumberT.Kind KIND_SIZEOF =
    IntegerT.fromRank(Limits64.SIZEOF_RANK, false);
  ...
  protected static final NumberT.Kind KIND_PTR_DIFF =
    IntegerT.fromRank(Limits64.PTRDIFF_RANK, true);
  ...
  protected static final NumberT.Kind KIND_WCHAR =
    IntegerT.fromRank(Limits64.WCHAR_RANK, Limits64.IS_WCHAR_SIGNED);
  ...
  public long getAlignment(Type type, boolean natural) {
    ...
    case FLOAT:
      ...
      case LONG_LONG:
      case U_LONG_LONG:
        return natural ? Limits64.LONG_LONG_NAT_ALIGN : Limits64.LONG_LONG_ALIGN;
      case FLOAT:
      ...
      case LONG_DOUBLE:
        return natural ? Limits64.LONG_DOUBLE_NAT_ALIGN : Limits64.LONG_DOUBLE_ALIGN;
      case FLOAT_COMPLEX:
        return natural ? Limits64.FLOAT_NAT_ALIGN : Limits64.FLOAT_ALIGN;
      case DOUBLE_COMPLEX:
        return natural ? Limits64.DOUBLE_NAT_ALIGN : Limits64.DOUBLE_ALIGN;
      ...
      if (! var.hasKind(VariableT.Kind.BITFIELD)) {
        ...
        if (isPacked && (GCC_LEGACY_LAYOUT || 0 != width)) {
          ...
          if (isLastMember || -1 == members.get(i+1).getWidth()) {
            ...
            if (0 != bitCount % Limits64.CHAR_BITS) size++;
        ...
        if (Constants.NAME_GCC.equals(att.getName())) {
          ...
          if ("aligned".equals(att.getName())) {
            if (null == att.getValue()) {
              alignment =
                Math.max(Limits64.LONG_LONG_ALIGN, Limits64.LONG_DOUBLE_ALIGN);
            } else {
  ...
  @SuppressWarnings("incomplete-switch")
    ...
    case INTEGER:
      ...
      case CHAR:
        return Limits64.IS_CHAR_SIGNED?
          Limits64.fitsChar(number) : Limits64.fitsUnsignedChar(number);
      case S_CHAR:
   ...
   */
    ...
    // signed.
    boolean flip = ((! Limits64.IS_INT_SIGNED) &&
                    type.hasVariable() &&
  ...
  protected final BigInteger FACTOR_CHAR =
    BigInteger.valueOf(2).pow(Limits64.CHAR_BITS);

  /** The factor for wide chars. */
  protected final BigInteger FACTOR_WIDE =
    BigInteger.valueOf(2).pow(Limits64.CHAR_BITS * Limits64.WCHAR_SIZE);
