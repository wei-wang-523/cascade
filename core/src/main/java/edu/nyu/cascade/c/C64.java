...
public class C64 extends C {
	...
	protected static final NumberT.Kind KIND_WCHAR = IntegerT.fromRank(
			Limits64.WCHAR_RANK, Limits64.IS_WCHAR_SIGNED);
	...
	public Type promote(Type type) {
		...
		// signed.
		boolean flip = ((!Limits64.IS_INT_SIGNED) && type.hasVariable() && type
				.toVariable().hasWidth());
	...
	protected final BigInteger FACTOR_WIDE = BigInteger.valueOf(2).pow(
			Limits64.CHAR_BITS * Limits64.WCHAR_SIZE);
