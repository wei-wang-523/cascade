 ...
 * outgoingEdges keep the points-to edges from cell to cell.
 * partitionView keep the points-to edge from partition to partition.
 * 
 * outgoingEdges are untouched after parsing. partitionView will be
 * simplified after equivalence relation propagation, and it will be
 * added new edges after ccjoin equivalence relation propagation.
 * 
 * @author Wei
 *
 */
...
public class PointsToGraph {
	...
	/**
	 * Propagate equivalence relation between cells in outgoingEdges
	 * by merging the entries with equivalent keys until saturated.
	 * @param uf
	 * @return
	 */
	...
	/**
	 * Helper method of propagateEquivalenceFully. Simplify the partitionView
	 * map by merging the entries with equivalent keys, and further unify their
	 * values (newly generated equiv relations for the next round propagation).
	 * @param uf
	 * @return
	 */
