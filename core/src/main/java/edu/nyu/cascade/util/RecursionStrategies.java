...
public final class RecursionStrategies {
	...
	public static <T, R> R binaryNode(Node node, Visitor visitor,
	...
	@SuppressWarnings("unchecked")
	public static <T, R> R binaryOp(Node node, Visitor visitor,
	...
	@SuppressWarnings("unchecked")
	public static <T, R> R unaryNode(Node node, Visitor visitor,
	...
	public static <T, R> Iterable<R> unaryRecursionOverList(
