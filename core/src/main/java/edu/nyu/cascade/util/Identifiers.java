...
public class Identifiers {
	...
	/**
	 * The elements associated with state expression or variable sets in pointer
	 * analysis
	 */
	...
	public static void defineLabel(SymbolTable symbolTable, String name,
			Object def) {
	...
	public static String toValidId(String s, IdType type) {
		...
		/*
		 * Replace non-id chars with underscore String newString =
		 * s.replaceAll("[^A-Za-z0-9_']", "_"); If the string begins with a digit or
		 * prime, add an underscore prefix if (newString.matches("^[0-9']")) {
		 * newString = "_" + newString; } return newString;
		 */
	}
