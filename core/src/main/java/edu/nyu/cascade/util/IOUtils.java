...
public class IOUtils {
	...
	/**
	 * "Pipes" all the data from a {@link java.io.Reader} into an
	 * {@link Appendable}.
	 * 
	 * @param inputReader
	 *          the reader from which to take the input data
	 * @param appendable
	 *          the object to which the data is output
	...
	/**
	 * Returns the debug printer, if debugging is enabled. Otherwise, returns a
	 * null printer.
	 */
	...
	/**
	 * Returns the tp-file printer, if tp-file is enabled. Otherwise, returns a
	 * null printer.
	 */
	...
	/**
	 * Return the trace-file stream, if traceFlag is enabled. Otherwise, returna a
	 * null stream.
	 */
	...
	/**
	 * Returns the debug stream, if debugging is enabled. Otherwise, returns a
	 * null stream.
	 */
	...
	/**
	 * Returns the stats stream, if stats is enabled. Otherwise, returns a null
	 * stream.
	 */
	...
	/**
	 * Returns the tp-file stream, if tp-file is enabled. Otherwrise, returns a
	 * null stream.
	 */
	...
	/**
	 * Disables debugging output. Also disables output to stdout and stderr, if
	 * they have not been explicitly enabled by a call to <code>enableOut()</code>
	 * or <code>enableErr()</code>.
	 */
	...
	/**
	 * Enables debugging output. Also enables output on stdout and stderr, if they
	...
	public static void enableTrace(File file) {
		...
		try {
			...
			if (!witnessXmlFile.exists())
				witnessXmlFile.createNewFile();
	 ...
	 * output, it only modifies the output stream. Use <code>enableErr()</code> to
	 * enable output.
	 */
	 ...
	 * output, it only modifies the output stream. Use <code>enableOut()</code> to
	 * enable output.
	 */
