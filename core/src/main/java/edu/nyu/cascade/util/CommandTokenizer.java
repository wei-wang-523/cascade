...
public final class CommandTokenizer {
  ...
  public static boolean isWord(CharSequence input) { return WORD.matcher(input).matches(); }
  ...
  public static class ArgList {
    ...
    public boolean equals(Object obj) { 
      if( !(obj instanceof ArgList) ) { return false; }
      else { return argList.equals( ((ArgList)obj).argList ); }
    }
    
    public String toString() { return argList.toString(); }
  }
