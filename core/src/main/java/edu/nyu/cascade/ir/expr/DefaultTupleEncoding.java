...
public class DefaultTupleEncoding implements TupleEncoding<TupleExpression> {
  ...
  public TupleExpression ofExpression(Expression expr) {
	...
	class DefaultTupleInstance implements TupleEncoding.Instance<TupleExpression> {
	  ...
	  public DefaultTupleInstance(ExpressionManager exprManager, String name, Iterable<TypeEncoding<?>> elementEncodings) {
	  ...
	  public DefaultTupleInstance(ExpressionManager exprManager, String name, TypeEncoding<?>... elementEncodings) {
	  ...
	  public TupleType getType() {
	    return getExpressionManager().tupleType(name, Iterables.transform(getElementEncodings(), 
