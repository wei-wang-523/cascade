...
public class CopyOfOrderLinearMemLayoutEncoding implements IROrderMemLayoutEncoding {
	
	private LinearHeapEncoding heapEncoding;
	@SuppressWarnings("unused")
	private Type addrType, valueType, sizeType;
	
	private CopyOfOrderLinearMemLayoutEncoding(LinearHeapEncoding heapEncoding) {
	...
	protected static CopyOfOrderLinearMemLayoutEncoding create(LinearHeapEncoding heapEncoding) {
		return new CopyOfOrderLinearMemLayoutEncoding(heapEncoding);
	}
