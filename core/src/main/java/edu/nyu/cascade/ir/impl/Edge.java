...
public class Edge implements IREdge<BasicBlock> {
  ...
  static Edge create(BasicBlock currentBlock, IRBooleanExpression guard, BasicBlock succ) {
  ...
  private Edge(BasicBlock currentBlock, IRBooleanExpression guard, BasicBlock succ) {
  ...
  public String toString() {
    return getSource().getId() + " --" + (guard == null ? "" : "[" + guard + "]") +
        "--> " + getTarget().getId();
  }
