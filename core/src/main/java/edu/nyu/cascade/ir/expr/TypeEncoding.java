...
public interface TypeEncoding<T extends Expression> {
	 ...
	 * 
	 * @param lhs
	 *          an expression in this encoding
	 * @param rhs
	 *          an expression in this encoding
	...
	/**
	 * Check whether this encoding was used for the given expression. This is a
	 * very approximate check: it will typically just check that the types match.
	 * 
	 * @param x
	 ...
	 * 
	 * @param e
	 *          an expression of the type handled by this encoding
