...
public interface IRLocation extends Comparable<IRLocation> {
	...
	/**
	 * Returns true if the location follows the basic block. The return value is
	 * undefined if the block and the location are not in the same file, or if the
	 * block does not have a defined end location.
	 */
	...
	/**
	 * Returns true if the location precedes the basic block. The return value is
	 * undefined if the block and the location are not in the same file, or if the
	 * block does not have a defined start location.
	 */
