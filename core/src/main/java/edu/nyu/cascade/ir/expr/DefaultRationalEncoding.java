...
public class DefaultRationalEncoding extends
	...
	@Override
	public BooleanExpression gt(RationalExpression lhs, RationalExpression rhs) {
		return lhs.gt(rhs);
	}

	@Override
	public BooleanExpression geq(RationalExpression lhs, RationalExpression rhs) {
		return lhs.geq(rhs);
	}
	...
	@Override
	public BooleanExpression leq(RationalExpression lhs, RationalExpression rhs) {
		return lhs.leq(rhs);
	}
