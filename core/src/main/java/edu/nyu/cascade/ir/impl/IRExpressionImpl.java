...
public class IRExpressionImpl implements IRExpression {
	/*
	 * public static IRExpressionImpl create(Node sourceNode) { return new
	 * IRExpressionImpl(sourceNode); }
	 */
	...
	/*
	 * protected IRExpressionImpl(Node sourceNode) { this(sourceNode,null); }
	 */
	...
	@Override
	public Expression toExpression(StateExpression pre,
