...
public class CopyOfSoundLinearMemLayoutEncoding implements IRSoundMemLayoutEncoding {
	
	private LinearHeapEncoding heapEncoding;
	@SuppressWarnings("unused")
	private Type addrType, valueType, sizeType;
	
	private CopyOfSoundLinearMemLayoutEncoding(LinearHeapEncoding heapEncoding) {
	...
	protected static CopyOfSoundLinearMemLayoutEncoding create(LinearHeapEncoding heapEncoding) {
		return new CopyOfSoundLinearMemLayoutEncoding(heapEncoding);
	}
