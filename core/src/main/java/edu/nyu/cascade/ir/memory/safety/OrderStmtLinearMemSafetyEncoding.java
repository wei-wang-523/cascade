...
public class OrderStmtLinearMemSafetyEncoding extends AbstractStmtMemSafetyEncoding {
	...
	private OrderStmtLinearMemSafetyEncoding(ExpressionEncoding encoding, IRDataFormatter formatter) {
	...
	public static OrderStmtLinearMemSafetyEncoding create(ExpressionEncoding encoding, IRDataFormatter formatter) {
