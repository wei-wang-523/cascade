...
public abstract class AbstractLocation implements IRLocation {
  ...
  /* TODO: Could give the wrong answer when the location is within the
  ...
  public boolean precedes(IRBasicBlock block) {
    Preconditions.checkNotNull(block);
    return block.getEndLocation() == null ? true : precedes(block.getStartLocation());
  }
  ...
  public boolean strictFollows(IRBasicBlock block) {
    Preconditions.checkNotNull(block);
    return block.getEndLocation() == null ? true : strictFollows(block.getEndLocation());
  }
  ...
  public boolean strictPrecedes(IRBasicBlock block) {
    Preconditions.checkNotNull(block);
    return block.getEndLocation() == null ? true : strictPrecedes(block.getStartLocation());
  }
