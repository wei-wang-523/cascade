...
*/
  ...
  /**
   * Use the default type as the type of the variable, only bit-vector
   * integer encoding needs the <code>iType</code> to get the actual
   * bit-vector type of the variable.
   */
  @Override
  ...
  /**
   * Use the default type as the type of bound variable, only bit-vector
   * integer encoding needs the <code>iType</code> to get the actual
   * bit-vector type of the bound variable.
   */
  @Override
  ...
  /**
   * Use the default type as the type of the bound Expression, only 
   * bit-vector integer encoding needs the <code>iType</code> to get 
   * the actual bit-vector type of the bound Expression.
   */
  @Override
  public E boundExpression(String name, int index, IRType iType, boolean fresh) {
