...
public class Statement implements IRStatement {
	...
	public static Statement declareArrayVar(Node sourceNode,
			IRExpressionImpl varExpr, IRExpression sizeExpr) {
		return new Statement(sourceNode, DECLARE_ARRAY, varExpr, sizeExpr);
	}

	public static Statement malloc(Node sourceNode, IRExpressionImpl ptrExpr,
			IRExpressionImpl sizeExpr) {
		return new Statement(sourceNode, MALLOC, ptrExpr, sizeExpr);
	}

	public static Statement calloc(Node sourceNode, IRExpressionImpl ptrExpr,
			IRExpressionImpl nitemExpr, IRExpressionImpl sizeExpr) {
		return new Statement(sourceNode, CALLOC, ptrExpr, nitemExpr, sizeExpr);
	}

	public static Statement alloca(Node sourceNode, IRExpressionImpl ptrExpr,
			IRExpressionImpl sizeExpr) {
	...
	public static Statement initialize(Node sourceNode, IRExpressionImpl varExpr,
			IRExpressionImpl valExpr) {
	...
	@Override
	public Expression getPreCondition(StateExpression pre,
