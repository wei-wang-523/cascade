...
public class BitVectorExpressionEncoding extends AbstractExpressionEncoding {
	...
	public static BitVectorExpressionEncoding create(
		...
		PointerEncoding<? extends Expression> pointerEncoding = LinearPointerEncoding
		    .create(BitVectorFixedSizeEncoding.create(exprManager,
		        (BitVectorIntegerEncoding) integerEncoding, size));
		return new BitVectorExpressionEncoding(integerEncoding, booleanEncoding,
