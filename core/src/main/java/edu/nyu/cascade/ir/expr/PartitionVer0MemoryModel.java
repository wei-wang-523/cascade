...
public class PartitionVer0MemoryModel extends AbstractMemoryModel {
   ...
   */
  public static PartitionVer0MemoryModel create(
    ...
    return new PartitionVer0MemoryModel(encoding, cellType);
  }
  ...
  protected PartitionVer0MemoryModel(ExpressionEncoding encoding, BitVectorType cellType) {
    super(encoding);
