...
public final class IRIntegerType extends IRType {
	...
	/*
	 * @Override public Object variable(IExpressionFactory<?, ?, ?> exprFactory,
	 * String id, boolean fresh) throws ExpressionFactoryException { return
	 * exprFactory.integerVar(id, fresh); }
	 * 
	 * @Override public IType<?> toType(IExpressionManager exprManager) { return
