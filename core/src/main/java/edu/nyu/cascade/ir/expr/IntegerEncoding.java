...
public interface IntegerEncoding<T extends Expression> extends TypeEncoding<T> {
	...
	/**
	 * Returns a boolean expression representing the bitwise OR of the two integer
	 * arguments.
	 */
	T bitwiseOr(T a, T b);
	...
	/**
	 * Returns a boolean expression representing the bitwise Negate of the integer
	 * argument.
	 */
	T bitwiseNegate(T a);
	...
	/**
	 * Returns an integer expression representing the character constant
	 * <code>c</code>.
	 */
	...
	/**
	 * Returns an integer expression representing the quotient of the two integer
	 * arguments.
	 */
	T divide(T lhs, T rhs);

	/**
	 * Returns an integer expression representing the remainder of the two integer
	 * arguments.
	 */
	T mod(T lhs, T rhs);
