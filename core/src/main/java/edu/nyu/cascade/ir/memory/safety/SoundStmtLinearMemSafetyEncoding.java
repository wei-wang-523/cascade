...
public class SoundStmtLinearMemSafetyEncoding extends AbstractStmtMemSafetyEncoding {
	...
	private SoundStmtLinearMemSafetyEncoding(ExpressionEncoding encoding, IRDataFormatter formatter) {
	...
	public static SoundStmtLinearMemSafetyEncoding create(ExpressionEncoding encoding, IRDataFormatter formatter) {
