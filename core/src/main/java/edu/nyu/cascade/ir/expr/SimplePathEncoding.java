...
//  private Expression assumps;
  ...
  public Expression assume(Iterable<? extends Expression> prefixes,
    ...
    Expression resMemStatePrime = resMemState;
    ExpressionClosure currentState = getMemoryModel().getCurrentState();
    if(currentState != null) resMemStatePrime = currentState.eval(resMemState);
    getMemoryModel().resetCurrentState();
    
    Expression resPcPrime = exprManager.ifThenElse(resPc, bool.eval(resMemState).asBooleanExpression(), 
        exprManager.ff());
    
    return exprManager.tuple(stateType, resMemStatePrime, resPcPrime);
  }
  ...
  public Expression assumeMemorySafe(Iterable<? extends Expression> prefixes,
    ...
    Expression memAssume = exprManager.and(getMemoryModel().getAssumptions(resMemState));
    Expression resPcPrime = exprManager.ifThenElse(resPc, memAssume, exprManager.ff());
    
    return exprManager.tuple(stateType, resMemState, resPcPrime);
  }
  ...
  public Expression assign(Iterable<? extends Expression> prefixes,
    ...
    Expression resMemStatePrime = getMemoryModel().assign(resMemState, 
        lval.eval(resMemState), rval.eval(resMemState));
    
    return exprManager.tuple(stateType, resMemStatePrime, resPc);
  }
  ...
  public Expression fieldAssign(Iterable<? extends Expression> prefixes,
    ...
    Expression resPcPrime = resPc;
    if(getMemoryModel() instanceof ReachMemoryModel) {
      ReachMemoryModel mm = (ReachMemoryModel) getMemoryModel();
      Expression memAssume = mm.fieldAssign(resMem, lval.eval(resMemState), field, rval.eval(resMemState));
      resPcPrime = exprManager.ifThenElse(resPc, memAssume, exprManager.ff());
    }
  ...
  public Expression alloc(Iterable<? extends Expression> prefixes,
    ...
    Expression resMemStatePrime = getMemoryModel().alloc(resMemState, 
        ptr.eval(resMemState), size.eval(resMemState));
  ...
  public Expression declareArray(Iterable<? extends Expression> prefixes,
    ...
    Expression resMemStatePrime = getMemoryModel().declareArray(resMemState, 
        ptr.eval(resMemState), size.eval(resMemState));
  ...
  public Expression declareStruct(Iterable<? extends Expression> prefixes,
    ...
    Expression resMemStatePrime = getMemoryModel().declareStruct(resMemState, 
        ptr.eval(resMemState), size.eval(resMemState));
  ...
  public Expression free(Iterable<? extends Expression> prefixes,
      Iterable<? extends Expression> preGuards, ExpressionClosure var) {
    Preconditions.checkArgument(Iterables.size(prefixes) == Iterables.size(preGuards));
    ExpressionManager exprManager = getExpressionManager();
    ...
    Expression resMemStatePrime = getMemoryModel().free(resMemState, var.eval(resMemState));
  ...
  public Expression havoc(Iterable<? extends Expression> prefixes,
    ...
    Expression resMemStatePrime = getMemoryModel().havoc(resMemState, lval.eval(resMemState));
