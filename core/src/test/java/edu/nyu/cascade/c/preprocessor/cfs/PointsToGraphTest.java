...
public class PointsToGraphTest {
	...
	@Test
	public void testPointsTo() throws PreProcessorException {
	...
	public void testPointsToFail() throws PreProcessorException {
		Cell s1 = cellManager.scalar(PtrSize);
	...
	@Test
	public void testPropagateEquivNoChange() throws PreProcessorException {
		Cell s1 = cellManager.scalar(PtrSize);
		Cell s2 = cellManager.scalar(1000);
	...
	@Test
	public void testPropagateEquivChange() throws PreProcessorException {
		Cell s1 = cellManager.scalar(PtrSize);
		Cell s2 = cellManager.scalar(1000);
		Cell s3 = cellManager.scalar(PtrSize);
		Cell s4 = cellManager.scalar(2000);
	...
	@Test
	public void testPropagateEquivCycleChange() throws PreProcessorException {
		Cell s1 = cellManager.scalar(PtrSize);
