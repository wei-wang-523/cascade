...
final class BitVectorTypeImpl extends TypeImpl implements BitVectorType {
	...
	@Override
	public BitVectorExpressionImpl mult(int size, Expression a, Expression b) {
		ExpressionManagerImpl em = getExpressionManager();
	...
	@Override
	public BitVectorExpressionImpl subtract(Expression a, Expression b) {
		return BitVectorExpressionImpl.mkMinus(getExpressionManager(), a, b);
	}

	@Override
	public BitVectorExpressionImpl lshift(Expression a, Expression b) {
		return BitVectorExpressionImpl.mkLShift(getExpressionManager(), a, b);
	}

	@Override
	public BitVectorExpressionImpl rshift(Expression a, Expression b) {
