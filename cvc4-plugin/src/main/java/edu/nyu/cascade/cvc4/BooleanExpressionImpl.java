  ...
  static BooleanExpressionImpl mkBvGeq(ExpressionManagerImpl exprManager,
    ...
    return new BooleanExpressionImpl(exprManager, Kind.GEQ,
        new BinaryConstructionStrategy() {
          ...
          public Expr apply(ExprManager em, Expr left, Expr right)
              throws Exception {
            return em.mkExpr(edu.nyu.acsys.CVC4.Kind.BITVECTOR_UGE, left, right);
          }
        }, a, b);
  }
  ...
  static BooleanExpressionImpl mkBvSGeq(ExpressionManagerImpl exprManager,
    ...
    return new BooleanExpressionImpl(exprManager, Kind.GEQ,
        new BinaryConstructionStrategy() {
          ...
          public Expr apply(ExprManager em, Expr left, Expr right)
              throws Exception {
            return em.mkExpr(edu.nyu.acsys.CVC4.Kind.BITVECTOR_SGE, left, right);
          }
        }, a, b);
  }
  ...
  static BooleanExpressionImpl mkBvGt(ExpressionManagerImpl exprManager,
    ...
    return new BooleanExpressionImpl(exprManager, Kind.GT,
        new BinaryConstructionStrategy() {
          ...
          public Expr apply(ExprManager em, Expr left, Expr right)
              throws Exception {
            return em.mkExpr(edu.nyu.acsys.CVC4.Kind.BITVECTOR_UGT, left, right);
          }
        }, a, b);
  }
  ...
  static BooleanExpressionImpl mkBvSGt(ExpressionManagerImpl exprManager,
    ...
    return new BooleanExpressionImpl(exprManager, Kind.GT,
        new BinaryConstructionStrategy() {
          ...
          public Expr apply(ExprManager em, Expr left, Expr right)
              throws Exception {
            return em.mkExpr(edu.nyu.acsys.CVC4.Kind.BITVECTOR_SGT, left, right);
          }
        }, a, b);
  }
  ...
  static BooleanExpressionImpl mkBvLeq(ExpressionManagerImpl exprManager,
    ...
    return new BooleanExpressionImpl(exprManager, Kind.LEQ,
        new BinaryConstructionStrategy() {
          ...
          public Expr apply(ExprManager em, Expr left, Expr right)
              throws Exception {
            return em.mkExpr(edu.nyu.acsys.CVC4.Kind.BITVECTOR_ULE, left, right);
          }
        }, a, b);
  }
  ...
  static BooleanExpressionImpl mkBvSLeq(ExpressionManagerImpl exprManager,
    ...
    return new BooleanExpressionImpl(exprManager, Kind.LEQ,
        new BinaryConstructionStrategy() {
          ...
          public Expr apply(ExprManager em, Expr left, Expr right)
              throws Exception {
            return em.mkExpr(edu.nyu.acsys.CVC4.Kind.BITVECTOR_SLE, left, right);
          }
        }, a, b);
  }
  ...
  static BooleanExpressionImpl mkBvLt(ExpressionManagerImpl exprManager,
    ...
    return new BooleanExpressionImpl(exprManager, Kind.LT,
        new BinaryConstructionStrategy() {
          ...
          public Expr apply(ExprManager em, Expr left, Expr right)
              throws Exception {
            return em.mkExpr(edu.nyu.acsys.CVC4.Kind.BITVECTOR_ULT, left, right);
          }
        }, a, b);
  }
  ...
  static BooleanExpressionImpl mkBvSLt(ExpressionManagerImpl exprManager,
    ...
    return new BooleanExpressionImpl(exprManager, Kind.LT,
        new BinaryConstructionStrategy() {
          ...
          public Expr apply(ExprManager em, Expr left, Expr right)
              throws Exception {
            return em.mkExpr(edu.nyu.acsys.CVC4.Kind.BITVECTOR_SLT, left, right);
          }
        }, a, b);
  }
    ...
    return new BooleanExpressionImpl(exprManager, Kind.DISTINCT,
        new NaryConstructionStrategy() {
          ...
          public Expr apply(ExprManager em, List<Expr> args)
            ...
            for(Expr arg : args)    argList.add(arg);
...
/*  static BooleanExpressionImpl mkHasType(ExpressionManagerImpl exprManager, Expression expr, final Type type) {
    final TypeImpl type2 = exprManager.importType(type);
    if( !exprManager.integerType().equals( type2 ) ) {
      throw new UnsupportedOperationException("mkHasType on non-integer type:" +  type);
    }
    return new BooleanExpressionImpl(exprManager, Kind.HAS_TYPE,
        new UnaryConstructionStrategy() {
          @Override
          public Expr apply(ExprManager em, Expr arg) {
            return em.getTypePred(type2.getCVC4Type(), arg);
          }
        }, expr);
  }*/
          ...
          public Expr apply(ExprManager em, List<Expr> args)
            ...
            for(Expr arg : args) {
              if(result == null)
                ...
                result = em.mkExpr(edu.nyu.acsys.CVC4.Kind.OR,
                    arg, result);
              }
            }
            return result;
  ...
  static BooleanExpressionImpl mkRewriteRule(ExpressionManagerImpl exprManager,
    ...
    return new BooleanExpressionImpl(exprManager, Kind.REWRITE_RULE,
        new BinderGuardConstructionStrategy() {
          @Override
          public Expr apply(ExprManager em, List<Expr> vars, Expr guard, Expr rule)
              throws Exception {
            vectorExpr varList = new vectorExpr();
            for(Expr var : vars)    varList.add(var);
            Expr boundVarList = em.mkExpr(edu.nyu.acsys.CVC4.Kind.BOUND_VAR_LIST, varList);
            return em.mkExpr(edu.nyu.acsys.CVC4.Kind.REWRITE_RULE, boundVarList, guard, rule);
          }
        }, vars, guard, rule);
  }
  ...
  static BooleanExpressionImpl mkRRRewrite(ExpressionManagerImpl exprManager,
    ...
    return new BooleanExpressionImpl(exprManager, Kind.RR_REWRITE,
        new BinaryConstructionStrategy() {
          @Override
          public Expr apply(ExprManager em, Expr h, Expr b)
              throws Exception {
  ...
  static BooleanExpressionImpl mkRRRewrite(ExpressionManagerImpl exprManager,
    ...
    return new BooleanExpressionImpl(exprManager, Kind.RR_REWRITE,
        new BinderTriggersWithRewriteRuleConstructionStrategy() {
          @Override
          public Expr apply(ExprManager em, Expr head, Expr body, List<Expr> triggers)
              throws Exception {
            vectorExpr triggerList = new vectorExpr();
            for(Expr trigger : triggers) {
              Expr pat = em.mkExpr(edu.nyu.acsys.CVC4.Kind.INST_PATTERN, trigger);
...
*/
  ...
  private BooleanExpressionImpl(ExpressionManagerImpl exprManager, boolean value) {
...
/*  private void internalSetTriggers() {
    ExprManager em = getExpressionManager()
        .getTheoremProver().getCvc4ExprManager();
    
    List<List<edu.nyu.acsys.CVC4.Expr>> cvc4Triggers = Lists.newArrayListWithCapacity(triggers.size());
    for ( ImmutableList<? extends Expression> multiTrigger : triggers ) {
      List<edu.nyu.acsys.CVC4.Expr> cvc4MultiTrigger = Lists.newArrayListWithCapacity(multiTrigger.size());
      for( Expression trigger : multiTrigger ) {
        cvc4MultiTrigger.add( getExpressionManager().toCvc4Expr(trigger) );
      }
