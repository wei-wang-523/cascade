...
final class TupleVariableImpl extends VariableExpressionImpl implements TupleExpression {
  ...
  static TupleVariableImpl create(
	...
	private TupleVariableImpl(ExpressionManagerImpl em, String name, Type type, boolean fresh) {
