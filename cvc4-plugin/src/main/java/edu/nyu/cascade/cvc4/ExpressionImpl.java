...
public class ExpressionImpl implements Expression {
	...
	/*
	 * NOTE: This constructor does not set cvc4_expr! The sub-class will be
	...
	protected ExpressionImpl(ExpressionManagerImpl em, Kind kind,
		...
		// new expression
		// Fortunately, Cascade don't use these children for now. So, it's safe for
		// now only.
		// Following is the right version of convert children, which cause invalid
		// memory access.
		init(expressions);
		List<Expr> exprs = convertChildrenToExpr();
