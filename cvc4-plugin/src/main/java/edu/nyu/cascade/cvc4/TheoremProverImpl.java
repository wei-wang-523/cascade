  ...
  private static final LoadingCache<TheoremProverImpl, ConcurrentMap<Expr, SatResult<?>>> satCache = CacheBuilder
    ...
    public ImmutableList<Option> getOptions() {
      return ImmutableList
      		.of(OptionBuilder.withLongOpt(OPTION_CVC4_STATS) //
      				.withDescription("Enable CVC4 stats") //
      				.create(), //
      				
      				OptionBuilder.withLongOpt(OPTION_CVC4_DECISION) //
              .withDescription("Set CVC4 decision") //
              .hasArg()
              .withArgName("S")
              .withType(String.class) //
              .create(), //
              
      				OptionBuilder.withLongOpt(OPTION_CVC4_ITE_SIMP) //
      				.withDescription("Enable CVC4 ite-simp") //
      				.create(), //
      				
      				OptionBuilder.withLongOpt(OPTION_CVC4_NO_ITE_SIMP) //
      				.withDescription("Enable CVC4 no-ite-simp") //
      				.create() //
      				);
    }
  }
