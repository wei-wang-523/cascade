...
final class TupleBoundExpressionImpl extends BoundExpressionImpl implements TupleExpression {

  static TupleBoundExpressionImpl create(
  ...
  private TupleBoundExpressionImpl(ExpressionManagerImpl exprManager, String name, TupleTypeImpl type, boolean fresh) {
	  super(exprManager, name, type, fresh);
	}
  
  static TupleBoundExpressionImpl create(
      ExpressionManagerImpl exprManager, String name, int index, TupleTypeImpl type, boolean fresh) {
