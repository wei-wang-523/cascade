...
final class RecordBoundExpressionImpl extends BoundExpressionImpl implements RecordExpression {
  
  static RecordBoundExpressionImpl create(
  ...
  private RecordBoundExpressionImpl(ExpressionManagerImpl exprManager, String name, RecordTypeImpl type, boolean fresh) {
