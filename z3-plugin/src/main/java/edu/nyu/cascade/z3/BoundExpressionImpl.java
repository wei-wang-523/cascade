...
class BoundExpressionImpl extends ExpressionImpl implements BoundExpression {
	...
	BoundExpressionImpl(final ExpressionManagerImpl exprManager, String name,
			final int index, Type type, boolean fresh) {
	...
	private BoundExpressionImpl(ExpressionManagerImpl exprManager, Expr expr,
			String name, Type type) {
		super(exprManager, BOUND, expr, type);
		setName(name);
	}

	static BoundExpressionImpl valueOfBound(ExpressionManagerImpl exprManager,
