...
final class IntegerTypeImpl extends TypeImpl implements IntegerType {
	...
	IntegerTypeImpl(ExpressionManagerImpl expressionManager) {
		...
		try {
			setZ3Type(
					expressionManager.getTheoremProver().getZ3Context().getIntSort());
		} catch (Z3Exception e) {
	...
	@Override
	public IntegerExpressionImpl add(Expression a, Expression b) {
	...
	@Override
	public IntegerExpressionImpl add(Iterable<? extends Expression> addends) {
		return IntegerExpressionImpl.mkPlus(getExpressionManager(), addends);
	}

	@Override
	public IntegerExpressionImpl divide(Expression a, Expression b) {
		return IntegerExpressionImpl.mkDivide(getExpressionManager(), a, b);
	}

	@Override
	public IntegerExpressionImpl mod(Expression a, Expression b) {
	...
	@Override
	public IntegerExpressionImpl mult(Expression left, Expression right) {
		return IntegerExpressionImpl.mkMult(getExpressionManager(), left, right);
	}

	@Override
	public IntegerExpressionImpl mult(Iterable<? extends Expression> terms) {
	...
	@Override
	public IntegerExpressionImpl pow(Expression base, Expression exp) {
		return IntegerExpressionImpl.mkPow(getExpressionManager(), base, exp);
	}

	@Override
	public IntegerExpressionImpl subtract(Expression a, Expression b) {
