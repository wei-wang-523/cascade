...
final class ArrayBoundExpressionImpl extends BoundExpressionImpl implements ArrayExpression {

  static ArrayBoundExpressionImpl create(
      ExpressionManagerImpl em, String name, 
      ArrayTypeImpl type, boolean fresh) {
    return new ArrayBoundExpressionImpl(em,name, type, fresh);
  }
  
  static ArrayBoundExpressionImpl create(
      ExpressionManagerImpl em, String name, int index, 
      ArrayTypeImpl type, boolean fresh) {
  ...
  private ArrayBoundExpressionImpl(ExpressionManagerImpl em, String name, int index, 
  		ArrayTypeImpl type, boolean fresh) {
