...
final class BitVectorTypeImpl extends TypeImpl implements BitVectorType {
	...
	@Override
	public BitVectorExpressionImpl add(int size, Expression a, Expression b) {
		ExpressionManagerImpl em = getExpressionManager();
	...
	@Override
	public BitVectorExpressionImpl bitwiseAnd(Expression a, Expression b) {
		return BitVectorExpressionImpl.mkAnd(getExpressionManager(), a, b);
	}

	@Override
	public BitVectorExpressionImpl bitwiseNand(Expression a, Expression b) {
		return BitVectorExpressionImpl.mkNand(getExpressionManager(), a, b);
	}

	@Override
	public BitVectorExpressionImpl bitwiseNor(Expression a, Expression b) {
	...
	@Override
	public BitVectorExpressionImpl bitwiseOr(Expression a, Expression b) {
		return BitVectorExpressionImpl.mkOr(getExpressionManager(), a, b);
	}

	@Override
	public BitVectorExpressionImpl bitwiseXnor(Expression a, Expression b) {
		return BitVectorExpressionImpl.mkXnor(getExpressionManager(), a, b);
	}

	@Override
	public BitVectorExpressionImpl bitwiseXor(Expression a, Expression b) {
		return BitVectorExpressionImpl.mkXor(getExpressionManager(), a, b);
	}

	@Override
	public BitVectorExpressionImpl concat(Expression a, Expression b) {
	...
	@Override
	public BitVectorExpression subtract(Expression a, Expression b) {
		return BitVectorExpressionImpl.mkMinus(getExpressionManager(), a, b);
	}

	@Override
	public BitVectorExpression lshift(Expression a, Expression b) {
		return BitVectorExpressionImpl.mkLShift(getExpressionManager(), a, b);
	}

	@Override
	public BitVectorExpression rshift(Expression a, Expression b) {
	...
	public BitVectorExpression variable(String name, boolean fresh) {
		return BitVectorVariableImpl.create(getExpressionManager(), name, this,
				fresh);
	}
	...
	public BitVectorBoundExpressionImpl boundVar(String name, boolean fresh) {
		return BitVectorBoundExpressionImpl.create(getExpressionManager(), name,
				this, fresh);
	}

	@Override
	public BitVectorBoundExpressionImpl boundExpression(String name, int index,
			boolean fresh) {
		return BitVectorBoundExpressionImpl.create(getExpressionManager(), name,
				index, this, fresh);
	}
	...
	BitVectorExpressionImpl createExpression(Expr res, Expression oldExpr,
		...
		return BitVectorExpressionImpl.create(getExpressionManager(), oldExpr
