...
final class UninterpretedBoundExpressionImpl extends BoundExpressionImpl
	...
	static UninterpretedBoundExpressionImpl create(
	...
	private UninterpretedBoundExpressionImpl(ExpressionManagerImpl exprManager,
			String name, UninterpretedTypeImpl type, boolean fresh) {
		super(exprManager, name, type, fresh);
	}

	static UninterpretedBoundExpressionImpl create(
			ExpressionManagerImpl exprManager, String name, int index,
			UninterpretedTypeImpl type, boolean fresh) {
		return new UninterpretedBoundExpressionImpl(exprManager, name, index, type,
				fresh);
	}
