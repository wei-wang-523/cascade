...
NUM __BUILTIN_DAED_FBETWEEN(NUM x, NUM y) {
	return (x+y)/2;
}

NUM __BUILTIN_DAED_FPRINT(NUM x, NUM y) {
	return x*y;
}
...
// LOC49: Add function definition of __BUILTIN_DAED_FPRINT(NUM x, NUM y)
/* float datatype & division operation */