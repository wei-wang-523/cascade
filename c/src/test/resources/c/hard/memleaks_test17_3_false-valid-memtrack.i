# 1 "memleaks_test17_3_false-valid-memtrack.c"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "memleaks_test17_3_false-valid-memtrack.c"
# 11 "memleaks_test17_3_false-valid-memtrack.c"
# 1 "header.h" 1
# 12 "header.h"
...
# 12 "memleaks_test17_3_false-valid-memtrack.c" 2
...
//  p = (struct A17 *)malloc(sizeof(struct A17));
  if(!p) goto err;
  array[i]=p;
 };
 return 0;
...
// struct A17 **array = (struct A17 **)malloc(sizeof(struct A17*)*len);
 if(array) {
  for(i=0; i<len; i++) {
   array[i]=0;
  }
