...
public class SteensfsStatsTest {
	...
	public SteensfsStatsTest(File file) {
	...
	public void test() throws ParseException, IOException {
		...
		SteensgaardFS fs = SteensgaardFS.create(symbolTable);
		fs.analysis(globalCFG, CFGs);
