...
public class FunctionParamGraphTest {
	private static final long PtrSize =
	...
	public void test() {
		...
		List<Cell> paramCells =
				Lists.newArrayList(returnCell, param1Cell, param2Cell);
	...
	public void testEquivPropagateChangeSameParamSize() {
		Cell func1Cell = cellManager.function();
		{
			...
			Cell param1Cell = cellManager.scalar(PtrSize);
			Cell param2Cell = cellManager.scalar(PtrSize);
			List<Cell> param1Cells = Lists.newArrayList(return1Cell, param1Cell, param2Cell);
		...
		Cell func2Cell = cellManager.function();
		{
			...
			List<Cell> param2Cells = Lists.newArrayList(return2Cell, param3Cell, param4Cell);
	...
	public void testEquivPropagateChangeDiffParamSize() {
		...
		Cell param1Cell = cellManager.scalar(PtrSize);
		Cell param2Cell = cellManager.scalar(PtrSize);
		List<Cell> param1Cells =
				Lists.newArrayList(return1Cell, param1Cell, param2Cell);
		funcGraph.put(func1Cell, param1Cells);
