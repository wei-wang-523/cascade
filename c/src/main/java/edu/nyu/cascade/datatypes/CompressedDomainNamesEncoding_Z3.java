...
public class CompressedDomainNamesEncoding_Z3 extends
	...
	protected ArrayExpression doToBvString(ArrayExpression bits1, Expression base,
			Expression len) {
	...
	// @Override
	/*
	 * public IBooleanExpression applyPredicate(String name, IExpression<?> arg1,
	 * IExpression<?> arg2) { if( FUN_DN.equals(name) ) {
	...
	/*
	 * @Override public BooleanExpression allocated(Expression ptr, Expression
	 * size) throws ExpressionFactoryException {
	 * Preconditions.checkArgument(!ptr.isDn);
	 * Preconditions.checkArgument(!size.isDn); return
	 * bitVectorFactory.allocated(ptr.bvVal, size.bvVal); }
	 */
	...
	/*
	 * @Override public ArrayType getStateType() { return memType; }
	 */
}
