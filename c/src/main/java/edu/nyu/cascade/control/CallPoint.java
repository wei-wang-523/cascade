...
public class CallPoint {
	...
	static edu.nyu.cascade.control.CallPoint valueOf(
		...
		return new CallPoint(file, line, funcName, col, startPosition, wayPoint,
				endPosition);
	}
	...
	private CallPoint(File file, BigInteger line, String funcName,
			BigInteger column, Position startPosition, List<Position> wayPoint,
