...
//
// private static final long defaultWidth =
// CType.getInstance().getWidth(CType.getUnitType());
// private static final long ptrWidth = CType.getInstance().getWidth(new
// PointerT(CType.getVoidType()));
//
...
//
// Type resType =
// symbolTable.lookupType(functionName).resolve().toFunction().getResult();
...
// Cell rhsCell = isFuncType ? ecrEncoder.toLval(rhsNode) :
...
// Cell argCell = isFuncType ? ecrEncoder.toLval(srcNode) :
