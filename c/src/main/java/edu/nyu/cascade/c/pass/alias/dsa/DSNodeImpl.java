...
final class DSNodeImpl extends DSNode {
	...
	static void reset() { nextId = BigInteger.ZERO; }
...
//	}
	...
	void growSizeForType(Type NewTy, long Offset) {
		if (NewTy == null || NewTy.isVoid())	return;
	...
	void addEdgeTo(long Offset, DSNodeHandle NH) {
		...
		if (isNodeCompletelyFolded())	Offset = 0;
	...
	public String toString() {
		  ...
		  if (NodeType != 0) {
		    OS.append(": ");
		    if ((NodeType & DSSupport.NodeTy.AllocaNode.value()) != 0)		OS.append("S");
		    if ((NodeType & DSSupport.NodeTy.HeapNode.value()) != 0)		OS.append("H");
		    if ((NodeType & DSSupport.NodeTy.GlobalNode.value()) != 0) 		OS.append("G");
		    if ((NodeType & DSSupport.NodeTy.UnknownNode.value()) != 0) 	OS.append("U");
		    if ((NodeType & DSSupport.NodeTy.IncompleteNode.value()) != 0)	OS.append("I");
		    if ((NodeType & DSSupport.NodeTy.ModifiedNode.value()) != 0) 	OS.append("M");
		    if ((NodeType & DSSupport.NodeTy.ReadNode.value()) != 0) 		OS.append("R");
		    if ((NodeType & DSSupport.NodeTy.ExternalNode.value()) != 0) 	OS.append("E");
		    if ((NodeType & DSSupport.NodeTy.ExternFuncNode.value()) != 0) 	OS.append("X");
		    if ((NodeType & DSSupport.NodeTy.IntToPtrNode.value()) != 0) 	OS.append("P");
		    if ((NodeType & DSSupport.NodeTy.PtrToIntNode.value()) != 0)	OS.append("2");
		    if ((NodeType & DSSupport.NodeTy.VAStartNode.value()) != 0)	 	OS.append("V");
		    if ((NodeType & DSSupport.NodeTy.DeadNode.value()) != 0) 		OS.append("<dead>");
		  }
