...
public abstract class DataStructures implements IRPass {
	...
	abstract boolean runOnModule(SymbolTable symTbl,
	...
	abstract DataStructures init(DataStructures D, boolean clone, boolean useAuxCalls,
	...
	boolean hasDSGraph(Function F) { return DSInfo.containsKey(F); }
	...
	void setDSGraph(Function F, DSGraph G) { DSInfo.put(F, G); }
	...
	DSCallGraph getCallGraph() { return CallGraph; }
	
	SuperSet<Type> getTypeSS() { return TypeSS; }

	ValueManager getValueManager() { return ValueManager; }
}
