...
public class GlobalVariable extends GlobalObject {
	static final ConcurrentMap<Pair<String, String>, GlobalVariable> globalVarCache = Maps.newConcurrentMap();

	protected GlobalVariable(String name, String scope, Type type) {
		super(name, scope, type);
	}

	static GlobalVariable getOrCreate(String varName, String varScope, Type varTy) {
	...
	static GlobalVariable get(String varName, String varScope) {
		Preconditions.checkArgument(globalVarCache.containsKey(Pair.of(varName, varScope)));
