...
/**
 * A wrapper for scalar type with an id, used for field sensitive type analysis.
 * For elements nested inside a structure or union the id is
 * structName.elemName.
 * 
 * @author Wei
 *
...
public final class FSType {
	...
	static FSType of(Type type, String typeName) {
		if (fsTypeMap.containsKey(typeName))
			return fsTypeMap.get(typeName);
