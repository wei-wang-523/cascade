...
public interface RunProcessor {
   ...
   * @throws RunProcessorException 
	 */
	SafeResult processReachability(IRControlFlowGraph mainCfg, LoopInfo loopInfo, String label, int iterTime)
			throws RunProcessorException;
   ...
   * @throws RunProcessorException 
	 */
	SafeResult processAssertion(IRControlFlowGraph mainCFG, LoopInfo loopInfo, int iterTime)
      throws RunProcessorException;
