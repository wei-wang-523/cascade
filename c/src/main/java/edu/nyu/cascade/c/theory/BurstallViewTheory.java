...
public class BurstallViewTheory implements Theory {
  ...
  private final TypeViewAnalyzer.Builder preprocessorBuilder;
  
  public BurstallViewTheory(ExpressionManager exprManager) {
    preprocessorBuilder = new TypeViewAnalyzer.Builder();
  ...
  @Override
  public TypeViewAnalyzer.Builder getPreprocessorBuilder() {
