...
class FunctionParamGraph {
	/**
	 * funcEdges tracks the function cell and its parameter cells. When propagate
	 * equivalence relation between function cells, all their parameter cells
	 * should be unified too. Remove the entries share the same function cells,
	 * but keep the one with maximum number of parameter cells.
	 */
	 ...
	 * of the returned value) into funcEdges. Check fails if lambdaCell is not
	 * Function cell.
	 * 
	 * @param lambdaCell
	 * @param paramCells
